...
#'
#' Checks core directories, package availability, and common project files.
#'
#' @return An object of class `"project_health_check"`.
#' @export
project_health_check <- function() {
  ...
  if (dir.exists("modules")) {
    required_dirs <- setdiff(required_dirs, "R")
    required_dirs <- c("modules", required_dirs)
  }
...
#'
#' @param x A project health check object.
#' @param ... Unused.
#'
#' @return `x`, invisibly.
#' @export
